					...
					<div className='w-full flex lg:flex-col items-center justify-between'>
						...
						<div className='w-1/2 lg:w-full lg:text-center flex flex-col items-center self-center'>
							...
							<p className='my-4 text-base font-medium  md:text-sm sm:text-xs'>
								Como desarrollador full-stack , me encanta
								convertir ideas en aplicaciones web
								innovadoras. Estoy en busca de un trabajo
								desafiante donde pueda usar mi experiencia
								en React y NextJS, siempre intentando crear
								paginas amigables al usuario con soluciones
								prácticas.
							</p>
