...
import tutorias from "../../public/images/projects/tutorias.svg";
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-24 xl:gap-x-12 lg:gap-x-8 md:gap-y-12 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="Landing Page"
                img={academiaNumen}
                summary="I got the chance to build their page with a nice and clean design using the latest technologies"
            ...
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="Landing Page"
                img={sofiLanding}
                summary="Built with Next and Tailwind CSS, a simply landing page to a tech Company"
            ...
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="Password Generator"
                img={todoApp}
                summary="Vainilla Javascript application that create and delete tasks"
                link="https://todo-list-rho-flax.vercel.app/"
                github="https://github.com/rosmildoLopes/todo-list"
              />
            </div>
            <div className="col-span-12">
              <FeaturedProject
                ...
                img={tutorias}
                summary="Vainilla Javascript application that create and delete tasks"
                link="https://tutorias-programacion.vercel.app/"
                github="https://github.com/NumenPublicidad/tutorias-programacion"
              />
            </div>
          </div>
        </Layout>
